...
int main()
{
  ...
  // ---------- Build model ----------
  std::string urdf_path = "/home/jkang/third_party/PRIME/data_g1_anitescu/unitree_description/urdf/g1/main.urdf";
  ...
  Eigen::MatrixXd xs_result = csvutil::readCSVtoEigen("data_g1_anitescu/xs_results_fddp.csv");
  Eigen::MatrixXd us_result = csvutil::readCSVtoEigen("data_g1_anitescu/us_results_fddp.csv");
  ...
  {
    Eigen::VectorXd ctrl_i = us_result.row(i).segment(0, model.nv).transpose();
