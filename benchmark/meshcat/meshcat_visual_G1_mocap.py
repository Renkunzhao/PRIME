...
def main():
    ...
    # 3) Load trajectories
    # ---------------------------
    csv_fddp = "/home/jkang/third_party/PRIME/data_g1_anitescu/mocap_hand/p_sim.csv"
    csv_sim  = "/home/jkang/third_party/PRIME/data_g1_anitescu/mocap_hand/p_sim.csv"
    ...
    q_fddp = q_fddp[:, 1:model.nq+1]
    q_sim  = q_sim[:,  1:model.nq+1]
    ...
    q_fddp = q_sim_sampled
    sleep_dt = 0.001  # playback speed
